...
const renderSpiner = function (parentElement) {
  const markup = `
  <div class="spinner">
    <svg>
...
const loadRecipe = async function (recipeId) {
  return new Promise(async (resolve, reject) => {
    try {
      const res = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${recipeId}`); // console.log(res);

      const resRecipe = await res.json(); // console.log(resRecipe);

      if (!res.ok) throw new Error(`${resRecipe.message} (${res.status})`);
      const {
        recipe: unformattedRecipe
      } = resRecipe.data;
      const recipe = formatRecipeObject(unformattedRecipe); // console.log(recipe);
...
},{"../internals/export":"10044f24ecae4059b4af184e71d3fba2"}],"772c82f30395fb0c9bc4800a9be3b567":[function(require,module,exports) {
...
},{"./bundle-manifest":"ba8df6b71e73837c465d69bebde6e64d"}]},{},["cecab51c57027216a0dcd1d133b00ea4","1ebf0956e594af66cc9d8a4318e4e192","175e469a7ea7db1c8c0744d04372621f"], null)
